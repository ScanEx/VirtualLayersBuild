...
/***/ function(module, exports) {
	...
	(function () {
	    ...
	    var GIBSLayerImage = L.TileLayer.extend({
	        initialize: function initialize(gibsID, options) {
	        ...
	        isTemporal: function isTemporal() {
	    ...
	    var GIBSLayerCanvas = L.TileLayer.Canvas.extend({
	        initialize: function initialize(layerName, options) {
	        ...
	        setTransparent: function setTransparent(isTransparent) {
	            this.options.transparent = isTransparent;
	            this._map && this.redraw();
	            return this;
	        },
	
	        _loadImage: function _loadImage(url, onLoaded, onError) {
	            var img = new Image();
	        ...
	        drawTile: function drawTile(canvas, tilePoint, zoom) {
	            ...
	            var tryToProcess = function tryToProcess() {
	    ...
	    L.GIBSLayer = function (gibsID, options) {
	        ...
	        options = options || {};
	        var needMask = layerInfo.date && 'transparent' in options && /jpg$/.test(layerInfo.template) && (gibsID.indexOf('Terra') !== -1 || gibsID.indexOf('Aqua') !== -1);
...
/***/ function(module, exports) {
	...
	(function () {
	    ...
	    var GIBSProxyLayer = function GIBSProxyLayer() {};
	    ...
	    window.gmxCore && gmxCore.addModule('GIBSVirtualLayer', { layerClass: GIBSProxyLayer }, {
	        init: function init(module, path) {
	            if (!L.GIBSLayer) {
	                return $.when(gmxCore.loadScript(path + 'GIBSLayer.js'), gmxCore.loadScript(path + 'GIBSMetadata.js'));
	            }
	        }
	    });
	})();
